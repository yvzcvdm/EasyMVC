...
$_SESSION['p_captcha'] = $captcha_string;
 
for($i = 0; $i < $string_length; $i++) {
  $letter_space = 120/$string_length;
  $initial = 5;
   
  imagettftext($image, 15, rand(-15, 15), $initial + $i*$letter_space, rand(25, 45), $textcolors[rand(0, 1)], $fonts[array_rand($fonts)], $captcha_string[$i]);
}
